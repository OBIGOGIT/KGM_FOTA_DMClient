...
public class tsDmParserAdd extends tsDmHandlecmd implements tsDefineWbxml
{
	public int				cmdid;
	...
	public int dmParseAdd(tsDmParser p)
	{
		int id = -1;
		int res = DM_ERR_OK;

		res = p.dmParseCheckElement(WBXML_TAG_Add);
		if (res != DM_ERR_OK)
		{
			return res;
		}
