...
public class tsDmParserCopy extends tsDmHandlecmd implements tsDefineWbxml
{
	public int				cmdid;
	...
	public int dmParseCopy(tsDmParser p)
	{
		int id = -1;
		int res = DM_ERR_OK;

		res = p.dmParseCheckElement(WBXML_TAG_Copy);
		if (res != DM_ERR_OK)
		{
			return res;
		}
