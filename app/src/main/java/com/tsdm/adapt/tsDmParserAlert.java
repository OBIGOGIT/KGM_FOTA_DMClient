...
public class tsDmParserAlert extends tsDmHandlecmd implements tsDefineWbxml
{
	public int				cmdid;
	...
	public int smParseAlert(tsDmParser p)
	{
		int id = -1;
		int res = DM_ERR_OK;

		res = p.dmParseCheckElement(WBXML_TAG_Alert);
		if (res != DM_ERR_OK)
		{
			return res;
		}
