...
public class tsDmParserGet extends tsDmHandlecmd implements tsDefineWbxml
{
	public int				cmdid;
	...
	public int dmParseGet(tsDmParser p)
	{
		int id = -1;
		int res = DM_ERR_OK;

		res = p.dmParseCheckElement(WBXML_TAG_Get);
		if (res != DM_ERR_OK)
		{
			return res;
		}
